...
#or modifier in run2_egamma_2016, run2_egamma_2017, run2_egamma_2018 :
...
#or modifier in run2_nanoAOD_94X2016,:
#   modifier.toModify(photonTable.variables,
...
#or modifier in run2_nanoAOD_94X2016, run2_miniAOD_80XLegacy:
#   modifier.toModify(slimmedPhotonsWithUserData.userFloats,
...
#limmedPhotonsTo106X = cms.EDProducer("ModifiedPhotonProducer",
#   src = cms.InputTag("slimmedPhotons"),
...
#un2_miniAOD_80XLegacy.toModify( slimmedPhotonsTo106X.modifierConfig.modifications, prependEgamma8XObjectUpdateModifier )

#or modifier in run2_miniAOD_80XLegacy,run2_nanoAOD_94XMiniAODv1,run2_nanoAOD_94XMiniAODv2,run2_nanoAOD_94X2016 ,run2_nanoAOD_102Xv1:
